# nvim-treesitter-queries-nim_format_string

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-nim_format_string/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-nim_format_string/actions/workflows/validate.yml)

Neovim tree-sitter queries for **nim_format_string**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-nim_format_string",
...
- [ ] Changes are scoped to `nim_format_string` — do not include files for other languages
